...
module.exports = function AnatomyJointsModule(pb) {
    ...
    /**
     * AnatomyJoints page of the pencilblue theme
     * @deprecated Since 0.4.1
     * @class AnatomyJoints
     * @constructor
     * @extends BaseController
     */
    function AnatomyJoints(){}
    util.inherits(AnatomyJoints, pb.BaseController);

    AnatomyJoints.prototype.init = function (props, cb) {
        var self = this;
    ...
    AnatomyJoints.prototype.render = function(cb)
    {
        var self = this;
        ...
        contentService.getSettings(function(err, contentSettings) {
            self.gatherData(function(err, data) {
                ...
                articleService.getMetaInfo(data.content[0], function(err, meta) {
                    ...
                    self.ts.registerLocal('meta_desc', 'Joints of the Foot and Ankle');
    ...
    AnatomyJoints.prototype.getTemplate = function(content, cb) {
        ...
        //preference and we can fall back on the default (anatomy_joints).  We depend on the
        ...
        //default case of "anatomy_joints"
        if (pieces.length === 1) {
    ...
    AnatomyJoints.prototype.getDefaultTemplatePath = function() {
        return 'anatomy_joints';
    };


    AnatomyJoints.prototype.gatherData = function(cb) {
        var self  = this;
        var tasks = {
    ...
    AnatomyJoints.prototype.loadContent = function(articleCallback) {
    ...
    AnatomyJoints.prototype.renderContent = function(content, contentSettings, themeSettings, anatomy_joints, cb) {
        var self = this;
        ...
        ats.registerLocal('article_anatomy_joints', anatomy_joints);
    ...
    AnatomyJoints.prototype.renderComments = function(content, ts, cb) {
        var self           = this;
    ...
    AnatomyJoints.prototype.renderComment = function(comment, cb) {
    ...
    AnatomyJoints.prototype.getContentSpecificPageName = function(content, cb) {
        if (!content) {
    ...
    AnatomyJoints.prototype.getNavigation = function(cb) {
        var options = {
        ...
        menuService.getNavItems(options, function(err, navItems) {
            if (util.isError(err)) {
                pb.log.error('AnatomyJoints: %s', err.stack);
            }
     ...
     */
    AnatomyJoints.getRoutes = function(cb) {
        var routes = [
            {
                method: 'get',
                path: '/he',

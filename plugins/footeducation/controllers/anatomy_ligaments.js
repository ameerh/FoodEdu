...
module.exports = function AnatomyLigamentsModule(pb) {
    ...
    /**
     * AnatomyLigaments page of the pencilblue theme
     * @deprecated Since 0.4.1
     * @class AnatomyLigaments
     * @constructor
     * @extends BaseController
     */
    function AnatomyLigaments(){}
    util.inherits(AnatomyLigaments, pb.BaseController);

    AnatomyLigaments.prototype.init = function (props, cb) {
        var self = this;
    ...
    AnatomyLigaments.prototype.render = function(cb)
    {
        var self = this;
        ...
        contentService.getSettings(function(err, contentSettings) {
            self.gatherData(function(err, data) {
                ...
                articleService.getMetaInfo(data.content[0], function(err, meta) {
                    ...
                    self.ts.registerLocal('meta_desc', 'Ligaments of the Foot and Ankle');
    ...
    AnatomyLigaments.prototype.getTemplate = function(content, cb) {
        ...
        //preference and we can fall back on the default (anatomy_ligaments).  We depend on the
        ...
        //default case of "anatomy_ligaments"
        if (pieces.length === 1) {
    ...
    AnatomyLigaments.prototype.getDefaultTemplatePath = function() {
        return 'anatomy_ligaments';
    };


    AnatomyLigaments.prototype.gatherData = function(cb) {
        var self  = this;
        var tasks = {
    ...
    AnatomyLigaments.prototype.loadContent = function(articleCallback) {
    ...
    AnatomyLigaments.prototype.renderContent = function(content, contentSettings, themeSettings, anatomy_ligaments, cb) {
        var self = this;
        ...
        ats.registerLocal('article_anatomy_ligaments', anatomy_ligaments);
    ...
    AnatomyLigaments.prototype.renderComments = function(content, ts, cb) {
        var self           = this;
    ...
    AnatomyLigaments.prototype.renderComment = function(comment, cb) {
    ...
    AnatomyLigaments.prototype.getContentSpecificPageName = function(content, cb) {
        if (!content) {
    ...
    AnatomyLigaments.prototype.getNavigation = function(cb) {
        var options = {
        ...
        menuService.getNavItems(options, function(err, navItems) {
            if (util.isError(err)) {
                pb.log.error('AnatomyLigaments: %s', err.stack);
            }
     ...
     */
    AnatomyLigaments.getRoutes = function(cb) {
        var routes = [
            {
                method: 'get',
                path: '/he',

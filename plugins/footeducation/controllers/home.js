...
module.exports = function homeModule(pb) {
    ...
    /**
     * home page of the pencilblue theme
     ...
     */
    function home(){}
    util.inherits(home, pb.BaseController);

    home.prototype.init = function (props, cb) {
        var self = this;
    ...
    home.prototype.render = function(cb)
    {
        var self = this;
        ...
        contentService.getSettings(function(err, contentSettings) {
            self.gatherData(function(err, data) {
                ...
                articleService.getMetaInfo(data.content[0], function(err, meta) {
                    ...
                    self.ts.registerLocal('meta_desc','Home');
    ...
    home.prototype.getTemplate = function(content, cb) {
        ...
        //preference and we can fall back on the default (home).  We depend on the
    ...
    home.prototype.getDefaultTemplatePath = function() {
        return 'home';
    };


    home.prototype.gatherData = function(cb) {
        var self  = this;
        var tasks = {
    ...
    home.prototype.loadContent = function(articleCallback) {
    ...
    home.prototype.renderContent = function(content, contentSettings, themeSettings, home, cb) {
        var self = this;
        ...
        ats.registerLocal('article_home', home);
    ...
    home.prototype.renderComments = function(content, ts, cb) {
        var self           = this;
    ...
    home.prototype.renderComment = function(comment, cb) {
    ...
    home.prototype.getContentSpecificPageName = function(content, cb) {
        if (!content) {
    ...
    home.prototype.getNavigation = function(cb) {
        var options = {

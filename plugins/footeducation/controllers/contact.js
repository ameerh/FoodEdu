...
module.exports = function contactModule(pb) {
    ...
    /**
     * contact page of the pencilblue theme
    ...
    contact.prototype.init = function (props, cb) {
        var self = this;
        ...
        contentService.getSettings(function(err, contentSettings) {
            self.gatherData(function(err, data) {
                ...
                articleService.getMetaInfo(data.content[0], function(err, meta) {
                    ...
                    self.ts.registerLocal('meta_desc', 'Feedback');
    ...
    contact.prototype.getTemplate = function(content, cb) {
        ...
        //preference and we can fall back on the default (contact).  We depend on the
    ...
    contact.prototype.getDefaultTemplatePath = function() {
        return 'contact';
    };


    contact.prototype.gatherData = function(cb) {
        var self  = this;
        var tasks = {
    ...
    contact.prototype.loadContent = function(articleCallback) {
    ...
    contact.prototype.renderContent = function(content, contentSettings, themeSettings, contact, cb) {
        var self = this;
        ...
        ats.registerLocal('article_contact', contact);
    ...
    contact.prototype.renderComments = function(content, ts, cb) {
        var self           = this;
    ...
    contact.prototype.renderComment = function(comment, cb) {
    ...
    contact.prototype.getContentSpecificPageName = function(content, cb) {
        if (!content) {
    ...
    contact.prototype.getNavigation = function(cb) {
        var options = {
        ...
        menuService.getNavItems(options, function(err, navItems) {
            if (util.isError(err)) {
                pb.log.error('contact: %s', err.stack);
            }
